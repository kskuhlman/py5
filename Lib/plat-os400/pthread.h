...
#endif /* __OS400_TGTVRM__ >= 510  @B1A*/
...
#if (__OS400_TGTVRM__ >= 510)    /*@B4A*/
  #define PTHREAD_CANCELEDEXTERNAL_NP (_pthread_canceledexternal_np())
#endif /* __OS400_TGTVRM__ >= 510  @B4A*/
#if ((__OS400_TGTVRM__ >= 510) && defined(__LLP64_IFC__))       /*@B1A*/
...
int pthread_clear_exit_np(void);
    ...
    ((__OS400_TGTVRM__ >= 510) && !defined(__LLP64_IFC__))      /*@B3A*/
...
#if (__OS400_TGTVRM__ < 510) || \
    ((__OS400_TGTVRM__ >= 510) && !defined(__LLP64_IFC__))      /*@B1A*/
...
int pthread_cleanup_peek_np(pthread_cleanup_entry_np_t *top);
  ...
  void pthread_cleanup_push(void (*__ptr64 routine)(void *__ptr64 ),
               void *__ptr64 arg);                              /*@B3A*/
  #pragma map(pthread_cleanup_push, "pthread_cleanup_push_ts64") /*@B1A*/
#endif                                                          /*@B1A*/
